...
namespace Telas
{
    internal class BancoFornecedores : InterfacesBanco
    {
        ...
        {
            container = new PanelP(300, 325, 85, 50, Color.White, tela);
            labelPs[0] = new LabelP(150, 20, 100, 65, "FORNECEDORES", tela);
            labelPs[0].Font = new Font("Arial", 12, FontStyle.Bold);
            labelPs[1] = new LabelP(30, 20, 135, 65, "ID:", tela);
            labelPs[2] = new LabelP(100, 20, 135, 130, "Nome:", tela);
            labelPs[3] = new LabelP(100, 20, 190, 65, "Razão Social:", tela);
            labelPs[4] = new LabelP(100, 20, 245, 65, "CNPJ:", tela);
            labelPs[5] = new LabelP(100, 20, 300, 65, "Endereco:", tela);
            labelPs[6] = new LabelP(100, 20, 355, 65, "Email:", tela);

            textBoxP[0] = new TextBoxP(30, 25, 155, 65, "", 9, tela, true);
            textBoxP[0].Enabled = false;
            textBoxP[1] = new TextBoxP(150, 25, 155, 130, "", 90, tela);
            textBoxP[2] = new TextBoxP(150, 25, 210, 65, "", 255, tela);
            textBoxP[3] = new TextBoxP(150, 25, 265, 65, "", 14, tela, isQuant: true);
            textBoxP[4] = new TextBoxP(150, 25, 320, 65, "", 255, tela);
            textBoxP[5] = new TextBoxP(150, 25, 375, 65, "", 80, tela);

            
            btnAdd = new ButtonP(true, 100, 50, 420, 65, "Cadastrar Fornecedor", tela);
            btnAdd.Enabled = false;
            btnAdd.Click += new EventHandler(Btn_add_Click);
            btnRemove = new ButtonP(true, 120, 50, 420, 210, "Remover Fornecedor", tela);
            btnRemove.Enabled = false;
            btnRemove.Click += new EventHandler(Btn_Remove_Click);
            btnUpdate = new ButtonP(true, 100, 25, 495, 147, "Atualizar Fornecedor", tela);
            ...
            dgv = new DataGridViewP(590, 500, 85, 480, dao.lerTabela("select * from Fornecedores"), tela);
            dgv.SelectionChanged += Dgv_SelectionChanged;
            container2 = new PanelP(610, 520, 85, 470, Color.FromArgb(99, 133, 199), tela);
        }
